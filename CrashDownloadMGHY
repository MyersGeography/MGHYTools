...
# The below is to be used for convenience (the first ws call)
#ws = r'//citydata/public/MSO_Engr/KDOT/CrashReports/'
#move the list local while the VPN is down
ws = r'C:/Users/cmyers/Downloads/crashdownload20220726/'
# download folder does not actually work - chrome controls this, not the command line ... this needs to be preexisting
download_folder = r'C:/Users/cmyers/Downloads/crashdownload20220726'
